    ...
    <ul>
        ...
        <li class="sign">
            <?php if ($currentUsername): ?>
                <span>Welcome, <?= htmlspecialchars($currentUsername) ?> | <a href="logout.php">Logout</a></span>
            <?php else: ?>
...
<div class="bg1">
    <div class="gallery">
        ...
        <figure>
            ...
            <figcaption><a href="">Margherita Pizza by cheEZy</a></figcaption>
        </figure>
        <figure>
    ...
    <nav class="categories">
        <ul>
            ...
            <li id="italian"><a href="italian.php">Italian</a></li>
